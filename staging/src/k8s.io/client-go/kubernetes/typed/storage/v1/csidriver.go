...
type CSIDriverInterface interface {
	Create(*v1.CSIDriver) (*v1.CSIDriver, error)
	Update(*v1.CSIDriver) (*v1.CSIDriver, error)
	Delete(name string, options *metav1.DeleteOptions) error
	DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(name string, options metav1.GetOptions) (*v1.CSIDriver, error)
	List(opts metav1.ListOptions) (*v1.CSIDriverList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CSIDriver, err error)
	CSIDriverExpansion
}
...
func (c *cSIDrivers) Get(name string, options metav1.GetOptions) (result *v1.CSIDriver, err error) {
	result = &v1.CSIDriver{}
	err = c.client.Get().
		Resource("csidrivers").
		Name(name).
...
func (c *cSIDrivers) List(opts metav1.ListOptions) (result *v1.CSIDriverList, err error) {
...
func (c *cSIDrivers) Create(cSIDriver *v1.CSIDriver) (result *v1.CSIDriver, err error) {
	result = &v1.CSIDriver{}
	err = c.client.Post().
		Resource("csidrivers").
		Body(cSIDriver).
...
func (c *cSIDrivers) Update(cSIDriver *v1.CSIDriver) (result *v1.CSIDriver, err error) {
	result = &v1.CSIDriver{}
	err = c.client.Put().
		Resource("csidrivers").
		Name(cSIDriver.Name).
...
func (c *cSIDrivers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CSIDriver, err error) {
	result = &v1.CSIDriver{}
