...
func (c *FakeCSIDrivers) Get(name string, options v1.GetOptions) (result *storagev1.CSIDriver, err error) {
	obj, err := c.Fake.
...
func (c *FakeCSIDrivers) List(opts v1.ListOptions) (result *storagev1.CSIDriverList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCSIDrivers) Create(cSIDriver *storagev1.CSIDriver) (result *storagev1.CSIDriver, err error) {
	obj, err := c.Fake.
...
func (c *FakeCSIDrivers) Update(cSIDriver *storagev1.CSIDriver) (result *storagev1.CSIDriver, err error) {
	obj, err := c.Fake.
...
func (c *FakeCSIDrivers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *storagev1.CSIDriver, err error) {
	obj, err := c.Fake.
